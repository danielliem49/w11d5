...
// this thunk action fetches details of the pokemon, from the backend, based on the browser's id wildcard param
...
// posts a pokemon POJO to the db
export const createPokemon = (pokemon) => async dispatch => {
  ...
  if (response.ok) {
    ...
    // returning the pokemon POJO, to be read by the history in the createPokemon form
    return details
  }
}

export const editPokemonDetails = (pokemon) => async dispatch => {
